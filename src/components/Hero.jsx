    ...
    >
      ...
      >
        ...
        <p className="text-xs font-medium">
          Trusted by over 200,000 clients worldwide
        </p>
      </motion.div>
      <motion.h1
        ...
        viewport={{ once: true }}
        className="text-4xl sm:text-5xl md:text-6xl xl:text-[84px] font-medium xl:leading-[95px] max-w-5-xl"
      >
      ...
      >
        Creating meaningful connections ensuring that your success is
        prioritized.
      </motion.p>
      <motion.div
      ...
      >
        ...
        <img
          src={assets.bgImage1}
          alt=""
          className="absolute -top-40 -right-40 sm:-top-100 sm:-right-70 -z-1 opacity-60 dark:hidden"
        />
      </motion.div>
    </div>
  );
